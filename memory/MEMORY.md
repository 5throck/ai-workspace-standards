...
| Date | Summary |
|------|---------|
| [2026-06-25](2026-06-25.md) | refactor(co-deck): remove scroll, notebook, slideshow themes — reduce from 8 to 5 |
| [2026-06-25](2026-06-25.md) | perf(hooks): eliminate duplicate audit.ts in pre-push during /sync pipeline |
