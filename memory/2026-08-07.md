...
## Session Summary
chore(deps): sync updated bun.lock lockfile to github for deployment consistency
...
## Session Summary
fix(templates): sync templates/common/scripts/SCRIPTS.md registry to fix post-scaffold audit ghost script detection
...
## Session Summary
fix(scripts): skip variant subdirectories in verify-scripts.ts to prevent false unregistered script errors during post-scaffold audit

## Changes
- `M scripts/verify-scripts.ts` — modified
...
## Session Summary
fix(scaffold): fix verify-scripts variant subdirectory handling and audit robustness across all 7 variants
...
## Session Summary
chore(co-deck): upgrade Projects/co-deck to template v0.5.3
