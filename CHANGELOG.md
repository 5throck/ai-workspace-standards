...
- **[2026-07-30]**: docs: add Spanish README (`README_es.md`) — Spanish translation of workspace README; updated `docs/workspace-schema.json` rootAllowlist to include `README_es.md`
