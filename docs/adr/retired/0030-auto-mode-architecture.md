> **DEPRECATED** (2026-06-05): This ADR is retired. Auto-Mode functionality was deemed unnecessary.
> Claude Code uses native Agent tool. Antigravity settings are managed via `.gemini/settings.json`
> without requiring Auto-Mode infrastructure.
