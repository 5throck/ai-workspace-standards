...
**Generated**: 2026-08-28T10:49:07.645Z
...
| audit.ts | 2.26.0 | scripts/audit.ts | bun |
...
| dev-sync.ts | 1.7.7 | scripts/dev-sync.ts | bun |
...
| generate-skill-graph.ts | 1.2.0 | scripts/generate-skill-graph.ts | N/A |
...
| upgrade-project.ts | 1.12.0 | scripts/upgrade-project.ts | N/A |
...
| validate-templates.ts | 1.15.2 | scripts/validate-templates.ts | js-yaml |
