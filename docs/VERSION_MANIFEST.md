...
**Generated**: 2026-09-09T08:00:56.988Z
...
| graft | 1.0.0 | active | .claude/skills/graft/SKILL.md | claude | N/A | N/A |
...
| project-resync | 1.2.0 | active | skills/project-resync/SKILL.md | workspace | project-resync, resync projects, sync project cycle | pm |
...
| audit.ts | 2.32.0 | scripts/audit.ts | bun |
...
| generate-skill-graph.ts | 1.8.4 | scripts/generate-skill-graph.ts | js-yaml |
...
| new-project.ts | 1.11.0 | scripts/new-project.ts | js-yaml |
...
| propagate-to-templates.ts | 2.7.0 | scripts/propagate-to-templates.ts | js-yaml |
...
| upgrade-project.ts | 1.19.2 | scripts/upgrade-project.ts | N/A |
...
| validate-templates.ts | 1.21.2 | scripts/validate-templates.ts | js-yaml |
