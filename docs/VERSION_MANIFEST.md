...
**Generated**: 2026-06-03T22:59:38.980Z
...
|------|------|------|-------|---------------|
| architect | agents/architect.md | high | inherit | 2026-06-01 |
...
| audit.ts | 2.5.1 | scripts/audit.ts | bun |
...
| publish-to-template.ts | 1.3.3 | scripts/publish-to-template.ts | N/A |
