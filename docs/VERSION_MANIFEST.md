...
**Generated**: 2026-09-15T23:02:25.462Z
...
- **Agents**: 8
- **Skills**: 51
- **Scripts**: 92 *(top-level CLI scripts; library/helper modules under `scripts/lib/`, `scripts/helpers/`, `scripts/hooks/`, and `scripts/validators/` plus experiment files under `scripts/experiments/` are excluded here — `scripts/SCRIPTS.md` is the full registry)*
- **Commands**: 8
...
| pm | agents/pm.md | medium | inherit | 2026-09-15 |
...
| simulate-pipeline | 1.0.0 | active | skills/simulate-pipeline/SKILL.md | workspace | simulate pipeline, simulate project, test scaffolding, dry run project creation, simulate l3 promotion, test l3 pipeline, dry run variant promotion | automation-engineer |
...
| create-l3-scaffold.ts | 1.14.0 | scripts/create-l3-scaffold.ts | N/A |
...
| lifecycle-sync-audit.ts | 1.13.0 | scripts/lifecycle-sync-audit.ts | js-yaml |
| list-template-versions.ts | 1.1.0 | scripts/list-template-versions.ts | bun |
| md-to-ooxml.ts | 1.2.0 | scripts/md-to-ooxml.ts | fs, path |
| new-project.ts | 1.17.0 | scripts/new-project.ts | js-yaml |
...
| test-l3-to-variant-promotion.ts | 1.2.1 | scripts/test-l3-to-variant-promotion.ts | bun |
| test-new-project.ts | 1.1.1 | scripts/test-new-project.ts | bun, js-yaml |
...
| validate-templates.ts | 1.29.0 | scripts/validate-templates.ts | js-yaml |
