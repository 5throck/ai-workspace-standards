...
**Generated**: 2026-09-13T23:27:44.162Z
...
| pm | agents/pm.md | high | inherit | 2026-09-13 |
...
| new-project.ts | 1.15.1 | scripts/new-project.ts | js-yaml |
...
| upgrade-project.ts | 1.26.0 | scripts/upgrade-project.ts | N/A |
