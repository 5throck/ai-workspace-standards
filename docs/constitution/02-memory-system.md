...
> **Tool consistency note**: All AI tools (Claude Code, Claude Desktop App, Antigravity, Antigravity CLI, Hermes Agent) MUST produce session logs with these exact four section headings. This ensures logs are machine-readable and consistent across tools.
