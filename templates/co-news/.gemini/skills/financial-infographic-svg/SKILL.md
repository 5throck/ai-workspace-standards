...
4. **Use Correct Korean Number Formatting**: When the article is in Korean, use Korean numeral groupings (jo/eok/man, i.e. trillion/hundred-million/ten-thousand units) rather than raw Western thousand-separated notation (e.g. "1.25 jo KRW" expressed in jo/eok units, not "KRW 1,250,000,000,000").
