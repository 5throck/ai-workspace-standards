...
| 4.7 | L0 to L1 Publish | **FATAL** (L0) / non-fatal (L1) | Propagates scripts, skills, commands, docs via workspace-root propagation tooling; fatal only in L0 context (context.md present) |
