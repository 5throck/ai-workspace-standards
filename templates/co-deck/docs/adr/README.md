...
## Variant Anchor — co-deck

Registered rule: **[DECK-R1]** — Trust Score below 70% blocks storyline advancement (`co-deck.context.md`, Domain Rules; threshold source `variant.json trust_score_thresholds.escalate`).

Likely first records: theme×style compatibility matrix rulings; image-manifest gate (Gate 3.5) policy changes; handbook H-stage quality-gate amendments.
