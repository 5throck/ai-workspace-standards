...
| **FullscreenManager** | **Browser Fullscreen API — toggle via F key or footer button (⤢/⤡); all 6 themes supported (ppt-engine themes + pitch + outlook via their own footer button); Escape exits fullscreen first before closing overlays** |
