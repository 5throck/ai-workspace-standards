...
> `handbook` and `handbook-sync-audit` were promoted to the common template (`templates/common/skills/`, 2026-08-30) — they are now available to all variants and resolve via `inherits_common`. |
