...
| Handbook Sync Audit | `handbook-sync-audit/` | Post-publication drift audit — workspace content reflection, structural/cross-handbook linkage, section-level language parity |
