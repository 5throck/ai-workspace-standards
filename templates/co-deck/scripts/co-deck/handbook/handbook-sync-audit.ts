#!/usr/bin/env bun
// @version 1.0.0
// scripts/co-deck/handbook/handbook-sync-audit.ts
...
//
// Usage:
//   bun scripts/co-deck/handbook/handbook-sync-audit.ts content --handbook-dir <docs> --workspace <ws> [--since 2026-08-01]
//   bun scripts/co-deck/handbook/handbook-sync-audit.ts structure --handbook-root <dir-containing-handbook-repos>
//   bun scripts/co-deck/handbook/handbook-sync-audit.ts parity --handbook-dir <docs>
//   bun scripts/co-deck/handbook/handbook-sync-audit.ts all ... (runs all three; flags shared)
//
