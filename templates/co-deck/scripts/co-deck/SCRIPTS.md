...
*Last Updated: 2026-08-16 — added missing handbook scripts (check-structure, check-tables, validate-handbook, deploy-handbook, update-footers) + 7 missing test entries; noted extract_slidedata.mjs co-deck vendored copy*
