...
*Last Updated: 2026-06-22 — measure-layout.ts v1.1.0 (HTML pre-flight validation: structure, slideData, slide elements); previous: gen-slides-pdf.ts 1.3.9 (contact slide HTML parity)*
