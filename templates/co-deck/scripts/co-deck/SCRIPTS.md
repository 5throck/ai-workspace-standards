...
*Last Updated: 2026-06-26 — gen-slides-pdf.ts v1.8.0 (increased PDF body/bullet font sizes for readability); previous: v1.7.0 (background image rendering with overlay)*
