...
| `handbook/scaffold-handbook.ts` | 1.1.0 | active | Generate handbook project scaffold — copies templates+assets+scripts, creates package.json, CI workflow, and README/LICENSE | `bun scripts/co-deck/handbook/scaffold-handbook.ts --project <path> [--output handbook/] [--lang ko] [--title ...] [--description ...] [--repo owner/name] [--chapters "Ch1,Ch2"]` |
