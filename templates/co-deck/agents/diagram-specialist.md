...
> **Design principle (inherited from gen-visual-images.ts v2.1.0)**: SVG is the source artifact; PNG is the delivery format. Never generate PNG directly — always derive it from the SVG.
