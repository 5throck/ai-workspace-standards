...
|------|-----------|---------------|-------------|
| `content` | Workspace design docs / ADRs whose keywords the handbook never mentions | Upstream feature landed after the handbook was written | Dispatch handbook-writer to add/refresh the relevant chapter section |
