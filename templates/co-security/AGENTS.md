...
**co-security Variant Agent Ecosystem**
...
| **patch-engineer** | [`agents/patch-engineer.md`](agents/patch-engineer.md) | Medium | Cross-platform patch deployment and remediation specialist |
| **pentester** | [`agents/pentester.md`](agents/pentester.md) | Medium | Vulnerability discovery, PoC development, and re-testing specialist |
| **red-team-lead** | [`agents/red-team-lead.md`](agents/red-team-lead.md) | High | Attack methodology, MITRE ATT&CK TTPs, and PoC review specialist |
| **report-writer** | [`agents/report-writer.md`](agents/report-writer.md) | Medium | Pentest reports and executive summary documentation specialist |
| **threat-modeler** | [`agents/threat-modeler.md`](agents/threat-modeler.md) | High | STRIDE analysis, ATT&CK mapping, and risk scoring specialist |
<!-- VARIANT-AGENTS-END -->
---
...
| Field | Value |
|-------|-------|
| **File** | [`agents/patch-engineer.md`](agents/patch-engineer.md) |
| **Tier** | medium |
| **Phases** | 4, 6 |
...
| Field | Value |
|-------|-------|
| **File** | [`agents/pentester.md`](agents/pentester.md) |
| **Tier** | medium |
| **Phases** | 3, 6 |
...
| Field | Value |
|-------|-------|
| **File** | [`agents/red-team-lead.md`](agents/red-team-lead.md) |
| **Tier** | high |
| **Phases** | 1, 2, 3 |
...
| Field | Value |
|-------|-------|
| **File** | [`agents/report-writer.md`](agents/report-writer.md) |
| **Tier** | medium |
| **Phases** | 5, 6 |
...
| Field | Value |
|-------|-------|
| **File** | [`agents/threat-modeler.md`](agents/threat-modeler.md) |
| **Tier** | high |
| **Phases** | 1, 2 |
...
|-------|-------|------------------|
| `patch-engineer` | Phase 4 | "patch engineer", "patch", "remediate", "fix vulnerability" |
| `pentester` | Phase 3 | "pentester", "security", "pentest", "vulnerability" |
| `red-team-lead` | Phase 1 | "red team lead", "threat model", "stride", "attack surface", "red team" |
| `report-writer` | Phase 5 | "report writer", "write", "document", "draft", "security" |
| `threat-modeler` | Phase 1 | "threat modeler", "research", "analyze", "investigate", "threat model" |
...
| Cross-platform patch deployment and remediation specialist | Phase 4, 6 | `patch-engineer` | Medium | |
| Vulnerability discovery | Phase 3, 6 | `pentester` | Medium | |
| Attack methodology | Phase 1, 2, 3 | `red-team-lead` | High | |
| Pentest reports and executive summary documentation specialist | Phase 5, 6 | `report-writer` | Medium | |
| STRIDE analysis | Phase 1, 2 | `threat-modeler` | High | |
...
> ℹ️ In-template navigation: `docs/context.md` materializes at scaffold time. The variant-authored context in this template is `docs/co-security.context.md`.
...
| patch-engineer | `agents/patch-engineer.md` | Medium | sequential (phase-ordered) | ✅ within phase scope |
| pentester | `agents/pentester.md` | Medium | sequential (phase-ordered) | ✅ within phase scope |
| red-team-lead | `agents/red-team-lead.md` | High | sequential (phase-ordered) | ✅ within phase scope |
| report-writer | `agents/report-writer.md` | Medium | sequential (phase-ordered) | ✅ within phase scope |
| threat-modeler | `agents/threat-modeler.md` | High | sequential (phase-ordered) | ✅ within phase scope |
...
| Cross-platform patch deployment and remediation specialist | `patch-engineer` | `pm` |
| Vulnerability discovery, PoC development, and re-testing specialist | `pentester` | `pm` |
| Attack methodology, MITRE ATT&CK TTPs, and PoC review specialist | `red-team-lead` | `pm` |
| Pentest reports and executive summary documentation specialist | `report-writer` | `pm` |
| STRIDE analysis, ATT&CK mapping, and risk scoring specialist | `threat-modeler` | `pm` |
