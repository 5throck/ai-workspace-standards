...
|---|-----------|--------|-----------------|
| 1 | **Phase A complete** | Done | `phaseAComplete` in variant.json; agent manifest (6), skill manifest (6), documentation present. |
| 2 | **Agent roster completeness** | Pending | All 6 agents defined; verify each agent file has substantive content. |
| 3 | **Skills coverage** | Pending | 6 variant-specific skills; verify each SKILL.md is complete and operational. |
