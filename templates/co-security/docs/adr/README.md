...
## Variant Anchor — co-security

Registered rule: **[SEC-R1]** — authorization first: no offensive work without a signed authorization document (`co-security.context.md`, Domain Rules).

Likely first records: rules-of-engagement amendments; scope re-authorization interpretation; patch-window and MNPI-adjacent handling policy.
