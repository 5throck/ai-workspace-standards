...
SPDX 2.3 (ISO/IEC 5962) Software Bill of Materials generation from dependency manifests, producing standard JSON SBOMs for compliance and vulnerability analysis.
...
dependency manifests (package.json / lockfiles / dependency closures)
