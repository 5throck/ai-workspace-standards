...
| `helpers/ticket-store.ts` | L0 | 1.2.0 | active | MoveOptions.result written to the ticket on done transitions (T-20260912-023) | —| L0 | —|
...
| `new-project.ts` | L0 | 1.15.0 | active | —| —| L0 | —|
...
| `propagate-to-templates.ts` | L0 | 2.12.0 | active | `--apply`, `--prune`, `--dry-run`, `--check-drift`, `--governance-l1`, `--docs`, `--include-disabled`, `--marker-rewrite` | —| L0 | —|
