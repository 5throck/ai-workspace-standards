...
| `audit.ts` | L0 | 2.10.6 | active | —| —| L0+L1 | —|
...
| `gen-pr-body.ts` | L0 | 1.1.4 | active | —| —| L0+L1 | —|
...
| `lifecycle-sync-audit.ts` | L0 | 1.4.2 | active | —| —| L0+L1 | —|
...
| `sync-skills.ts` | L0 | 1.0.1 | active | — | — | L0+L1 | — |
...
| `validate-templates.ts` | L0 | 1.5.10 | active | —| —| L0 | —|
