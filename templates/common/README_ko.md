...
1. **설정 검토**: `AGENTS.md`, `CLAUDE.md`, `GEMINI.md`를 참고하여 프로젝트의 역할과 목표에 맞게 갱신합니다.
2. **스크립트 갱신**: `scripts/` 내의 스크립트(예: `dev-sync.sh`, `audit.sh`)를 검토하고, 플레이스홀더 로직을 프로젝트 전용 요구사항으로 교체합니다.
