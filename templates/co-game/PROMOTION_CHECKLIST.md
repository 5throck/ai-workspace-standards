...
|---|-----------|--------|-----------------|
| 1 | **Phase A complete** | Done | `phaseAComplete` in variant.json; agent manifest (13), skill manifest (5), documentation present. |
| 2 | **Agent roster completeness** | Pending | All 13 agents defined; verify each agent file has substantive content. |
| 3 | **Skills coverage** | Pending | 5 variant-specific skills; verify each SKILL.md is complete and operational. |
