...
>   → docs/co-game.context.md
>
> ⚠️ This file is IMMUTABLE after project creation.
>    All project-specific changes belong in docs/co-game.context.md
...
<project-root>/
├── src/          # Source code
├── docs/         # context.md (this file) + co-game.context.md + ADRs
...
| `docs/co-game.context.md` | Variant config — tech stack, agents, skills, scripts, workflow |
...
This project follows the workspace coding standards defined in the workspace governance documentation.
...
### Workspace Governance Reference

All projects must follow workspace governance standards for agent, skill, and script lifecycle management.
