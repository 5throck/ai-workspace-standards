...
| 게임 디자이너 | `game-designer.md` | 범용 게임 설계: 코어 루프, 난이도, 보상, 튜토리얼 |
| 아케이드 디자이너 | `arcade-designer.md` | 레트로 아케이드 게임 설계: 엔티티 AI, 웨이브 시스템, 스코어링 |
| 퍼즐 디자이너 | `puzzle-designer.md` | 퍼즐/보드 게임 설계: 매칭 로직, 턴 시스템, 난이도 생성 |
| 디자이너 | `designer.md` | UI/UX 사양 및 와이어프레임 작성 |
| 비주얼 아티스트 | `visual-artist.md` | 시각 에셋: 스프라이트, 애니메이션, 보드/타일, 배경, HUD |
| 사운드 디자이너 | `sound-designer.md` | 절차적 오디오: SFX, BGM 루프, 오디오 이펙트 |
| 게임 개발자 | `game-developer.md` | Canvas 엔진, 게임 루프, 엔티티, 시스템 구현 |
| 게임 디버거 | `game-debugger.md` | 버그 분석, 수정 제안, 패턴 문서화 |
...
- **디자인** - 아키텍트, 디자이너, 게임 디자이너, 아케이드 디자이너, 퍼즐 디자이너
- **에셋** - 비주얼 아티스트, 사운드 디자이너
- **실행** - 게임 개발자, 게임 디버거, 테스트 실행자
- **보안/설정** - 스택 설정
