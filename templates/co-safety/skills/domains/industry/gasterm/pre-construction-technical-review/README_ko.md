...
Execute KGS Code pre-construction technical review (시설·기술 기준) for gas terminal facilities (LNG/LPG/수소). Reviews design documentation, material specifications, and construction plans against KGS safety requirements.
