...
Execute KGS on-site completion inspection and permit issuance for gas terminal facilities (LNG/LPG/수소). Final verification of all safety systems, pressure testing, leak testing, and operational readiness before facility commissioning.
