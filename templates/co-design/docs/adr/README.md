...
## Variant Anchor — co-design

Registered rule: **[DESIGN-R1]** — all new components require design-system review from the Design Lead (`co-design.context.md`, Domain Rules).

Likely first records: design-token schema evolution; accessibility-audit scope thresholds; user-testing evidence requirements before finalizing decisions.
