...
|---|-----------|--------|-----------------|
| 1 | **Phase A complete** | Done | `phaseAComplete` in variant.json; agent manifest (8), skill manifest (4), documentation present. |
| 2 | **Agent roster completeness** | Pending | All 8 agents defined; verify each agent file has substantive content. |
