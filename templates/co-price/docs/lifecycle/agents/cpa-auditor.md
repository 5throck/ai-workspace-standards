# P&L Engine Auditor (CPA) (cpa-auditor) Agent Lifecycle
...
- [x] Agent role clearly defined: audit
...
**P&L Engine Auditor (CPA)** — audit subdomain of the co-price variant ecosystem.

The authoritative runtime definition lives in [`agents/cpa-auditor.md`](../../../agents/cpa-auditor.md);
