# Cost & Asset Management (cost-asset-mgmt) Agent Lifecycle
...
- [x] Agent role clearly defined: cost
...
**Cost & Asset Management** — cost subdomain of the co-price variant ecosystem.

The authoritative runtime definition lives in [`agents/cost-asset-mgmt.md`](../../../agents/cost-asset-mgmt.md);
