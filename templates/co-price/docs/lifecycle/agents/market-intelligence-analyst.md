# Market Intelligence Analyst (market-intelligence-analyst) Agent Lifecycle
...
- [x] Agent role clearly defined: research
...
**Market Intelligence Analyst** — research subdomain of the co-price variant ecosystem.

The authoritative runtime definition lives in [`agents/market-intelligence-analyst.md`](../../../agents/market-intelligence-analyst.md);
