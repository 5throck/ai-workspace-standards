# Engagement Director (engagement-director) Agent Lifecycle
...
- [x] Agent role clearly defined: delivery
...
**Engagement Director** — delivery subdomain of the co-price variant ecosystem.

The authoritative runtime definition lives in [`agents/engagement-director.md`](../../../agents/engagement-director.md);
