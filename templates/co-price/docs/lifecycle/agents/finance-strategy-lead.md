# Finance Strategy & Channel Lead (finance-strategy-lead) Agent Lifecycle
...
- [x] Agent role clearly defined: strategy
...
**Finance Strategy & Channel Lead** — strategy subdomain of the co-price variant ecosystem.

The authoritative runtime definition lives in [`agents/finance-strategy-lead.md`](../../../agents/finance-strategy-lead.md);
