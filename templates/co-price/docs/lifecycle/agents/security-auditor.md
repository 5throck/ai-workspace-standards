# Security Auditor (security-auditor) Agent Lifecycle
...
- [x] Agent role clearly defined: security
...
**Security Auditor** — security subdomain of the co-price variant ecosystem.

The authoritative runtime definition lives in [`agents/security-auditor.md`](../../../agents/security-auditor.md);
