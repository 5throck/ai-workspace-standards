# Core Engine Developer (core-engine-dev) Agent Lifecycle
...
- [x] Agent role clearly defined: engine
...
**Core Engine Developer** — engine subdomain of the co-price variant ecosystem.

The authoritative runtime definition lives in [`agents/core-engine-dev.md`](../../../agents/core-engine-dev.md);
