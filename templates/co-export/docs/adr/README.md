...
## Variant Anchor — co-export

Registered rule: **[EXPORT-R1]** — the Phase 2 gate is mandatory; no Phase 3 execution on unapproved compliance findings (`co-export.context.md`, Domain Rules).

Likely first records: HS/FTA classification tooling choices; jurisdiction-conflict reconciliation policy for home vs destination findings; denied-party screening escalation paths.
