...
scope: co-export
description: >
  Guides the Logistics Coordinator through Incoterms 2020 term selection, freight mode/forwarder
  comparison, and bonded-warehouse/customs clearance logistics planning, ending in final
  engagement delivery handoff.
version: 1.0.0
...
2. **Incoterms Selection**: Recommend the appropriate Incoterms 2020 term given deal structure and
   each party's risk appetite and logistics capability. For DDP specifically, confirm the seller
   has the compliance/documentation capability to handle destination-country import clearance
   before recommending it.
3. **Freight Mode Comparison**: Compare sea/air/land freight on cost, transit time, and cargo
   suitability (weight, value density, perishability, restricted-carrier concerns).
4. **Check Cargo Restrictions**: Cross-check the recommended freight mode/route against any cargo
   restriction identified by `export-control-compliance-specialist` (e.g. restricted carriers or
   routes for controlled items).
5. **Forwarder Selection Criteria**: Outline the criteria for forwarder selection relevant to this
   shipment's specifics.
6. **Bonded Warehouse / Clearance Logistics**: Plan any bonded-storage or transshipment steps,
   coordinated with the customs clearance documentation already prepared.
7. **Final Delivery Handoff**: Confirm all upstream deliverables (compliance findings, documents,
...
- [ ] Recommended Incoterms term cites Incoterms 2020 definition and rationale
