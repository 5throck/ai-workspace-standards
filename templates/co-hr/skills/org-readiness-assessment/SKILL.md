...
Use in Phase 1 alongside compliance and workforce-statistics diagnosis. The change management cost estimates produced here support engagement budgeting rather than feeding a dedicated financial-modeling skill (co-hr has none).

## When to Use

- When beginning a consulting engagement that involves organizational transformation
- Before budgeting an engagement that must account for change management costs
...
5. **Change Management Cost Estimation**:
   ...
   - **Total change management cost range** (this estimate supports engagement budgeting)
