...
## Variant Anchor — co-hr

Registered rule: **[HR-R1]** — confirm the applicable jurisdiction with the client before any statutory work when no country profile is active (`co-hr.context.md`, Domain Rules).

Likely first records: country-profile statute-family additions; metric-dictionary scope rulings; engagement-phase deliverable language defaults.
