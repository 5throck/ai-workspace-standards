...
Use in Phase 1 to establish the stakeholder landscape before any recommendations are made. Since co-hr has no separate communications role, the Change Management Partner leads message development directly from these outputs rather than handing off to another agent.
...
6. **Message Development**: The Change Management Partner develops the messaging directly from the strategy matrix above — co-hr has no separate communications-lead role to hand off to.
