...
| **career-succession-consultant** | [`agents/career-succession-consultant.md`](agents/career-succession-consultant.md) | Medium | Career and succession consultant - designs career pathing, leadership pipelines, and succession plans (HRD). Use when: c |
...
### career-succession-consultant

| Field | Value |
|-------|-------|
| **File** | [`agents/career-succession-consultant.md`](agents/career-succession-consultant.md) |
| **Tier** | medium |
| **Phases** | 2 |
| **Role** | Career and succession consultant - designs career pathing, leadership pipelines, and succession plans (HRD). Use when: career-path design, leadership pipeline design, or succession planning required. |
...
| **Tier** | medium |
| **Phases** | 1, 2 |
| **Role** | Change management partner - manages change for org restructuring or new HR system rollouts, stakeholder alignment, resistance management, and organizational culture diagnosis with a DEI (diversity, equity, inclusion) lens. Use when: change management planning, stakeholder alignment, resistance management, or culture/DEI assessment required. |

### compensation-benefits-analyst

| Field | Value |
|-------|-------|
| **File** | [`agents/compensation-benefits-analyst.md`](agents/compensation-benefits-analyst.md) |
| **Tier** | medium |
| **Phases** | 2 |
| **Role** | Compensation and benefits analyst - designs wage structures, incentive schemes, benefits programs, and conducts compensation benchmarking (HRM). Use when: pay structure design, incentive plan design, benefits design, or compensation benchmarking required. |
...
| **Tier** | medium |
| **Phases** | 1, 3 |
| **Role** | HR data analyst - analyzes workforce statistics, turnover, hiring conversion, and labor-cost data, and builds HR dashboards / people analytics. Use when: workforce statistics analysis, turnover/conversion analysis, labor-cost analysis, or HR dashboard/people-analytics work required. |
...
| Field | Value |
|-------|-------|
| **File** | [`agents/learning-development-specialist.md`](agents/learning-development-specialist.md) |
| **Tier** | medium |
| **Phases** | 2 |
| **Role** | Learning and development specialist - designs training systems, competency models, and training program operations (HRD). Use when: training system design, competency model design, or training program design/operation required. |
...
| Field | Value |
|-------|-------|
| **File** | [`agents/performance-management-consultant.md`](agents/performance-management-consultant.md) |
| **Tier** | medium |
| **Phases** | 2 |
| **Role** | Performance management consultant - designs performance evaluation systems, KPI/OKR frameworks, and feedback processes (HRM). Use when: evaluation system design, KPI/OKR framework design, or feedback process design required. |
...
| Field | Value |
|-------|-------|
| **File** | [`agents/talent-acquisition-specialist.md`](agents/talent-acquisition-specialist.md) |
| **Tier** | medium |
| **Phases** | 2 |
| **Role** | Talent acquisition specialist - designs recruiting strategy, sourcing channels, selection processes, and talent pipelines (HRM). Use when: recruiting strategy, sourcing plan, selection/interview process design, or talent pipeline design required. |
...
| `career-succession-consultant` | Phase 2 | "career-succession-consultant task needed", "career-succession-consultant work required" |
| `change-management-partner` | Phase 1, Phase 2 | "change-management-partner task needed", "change-management-partner work required" |
| `compensation-benefits-analyst` | Phase 2 | "compensation-benefits-analyst task needed", "compensation-benefits-analyst work required" |
| `data-analyst` | Phase 1, Phase 3 | "data-analyst task needed", "data-analyst work required" |
| `labor-compliance-analyst` | Phase 1 | "labor-compliance-analyst task needed", "labor-compliance-analyst work required" |
| `labor-relations-specialist` | Phase 1, Phase 2 | "labor-relations-specialist task needed", "labor-relations-specialist work required" |
| `learning-development-specialist` | Phase 2 | "learning-development-specialist task needed", "learning-development-specialist work required" |
| `org-design-consultant` | Phase 2, Phase 3 | "org-design-consultant task needed", "org-design-consultant work required" |
| `performance-management-consultant` | Phase 2 | "performance-management-consultant task needed", "performance-management-consultant work required" |
| `safety-health-officer` | Phase 1 | "safety-health-officer task needed", "safety-health-officer work required" |
| `talent-acquisition-specialist` | Phase 2 | "talent-acquisition-specialist task needed", "talent-acquisition-specialist work required" |
<!-- VARIANT-DISPATCH-TRIGGERS-END -->
**⚠️ IMPORTANT**: Do NOT invoke any specialist agent directly. All requests must go through PM.

> **Execution Plan Format**: For mandatory criteria, boilerplate table, and rules, see [§5 Execution Plan Templates](#§5-execution-plan-templates). For platform-specific dispatch instructions, see `CLAUDE.md §5` or `GEMINI.md §5`.
...
| Career and succession consultant - designs career pathing, leadership pipelines, | Phase 2 | `career-succession-consultant` | medium | |
...
> ℹ️ In-template navigation: `docs/context.md` materializes at scaffold time. The variant-authored context in this template is `docs/co-hr.context.md`.
...
| career-succession-consultant | `agents/career-succession-consultant.md` | Medium | ⚠️ sequential preferred | project files |
| change-management-partner | `agents/change-management-partner.md` | Medium | ⚠️ sequential preferred | project files |
| compensation-benefits-analyst | `agents/compensation-benefits-analyst.md` | Medium | ⚠️ sequential preferred | project files |
| data-analyst | `agents/data-analyst.md` | Medium | ⚠️ sequential preferred | project files |
| labor-compliance-analyst | `agents/labor-compliance-analyst.md` | Medium | ⚠️ sequential preferred | project files |
| labor-relations-specialist | `agents/labor-relations-specialist.md` | Medium | ⚠️ sequential preferred | project files |
| learning-development-specialist | `agents/learning-development-specialist.md` | Medium | ⚠️ sequential preferred | project files |
| org-design-consultant | `agents/org-design-consultant.md` | Medium | ⚠️ sequential preferred | project files |
| performance-management-consultant | `agents/performance-management-consultant.md` | Medium | ⚠️ sequential preferred | project files |
| safety-health-officer | `agents/safety-health-officer.md` | Medium | ⚠️ sequential preferred | project files |
| talent-acquisition-specialist | `agents/talent-acquisition-specialist.md` | Medium | ⚠️ sequential preferred | project files |
...
| Career and succession consultant - designs career pathing, leadership pipelines, | `career-succession-consultant` | `pm` |
