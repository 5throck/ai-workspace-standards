...
## Variant Anchor — co-work

Registered rule: **[WORK-R1]** — corporate document styles are SSOT'd in `docs/document-style-registry.json`; OOXML producers MUST consume it rather than invent styles (`co-work.context.md`, Domain Rules).

Likely first records: style-bundle registry schema evolution; research source-citation policy amendments; publication version-control workflow changes.
