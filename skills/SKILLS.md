...
| `sync` | 1.4.0 | active | pm | 2026-09-12 | — | Full project sync pipeline — lifecycle, audit, publish, commit, push, PR. Reassigned from lifecycle-manager — same orphan cause as security-scan |
...
| `upgrade-project` | 1.3.2 | active | pm | 2026-09-12 | — | Upgrade existing L2/L3 project to current template version |
...
| `project-resync` | 1.3.0 | active | pm | 2026-09-12 | — | Whole-fleet bidirectional cycle: provenance audit (resync-audit.ts) → project GitHub sync → selective backport → root sync → upgrades. Operator skill; distinct from `sync` |
