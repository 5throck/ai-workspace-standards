...
| `explain-me` | 1.0.0 | experimental | pm | 2026-08-03 | — | Single-file interactive HTML report generation. Based on beret21/reportme (MIT). Korean loanword data in references/loanword-refinements.json |
