 ...
 *
 * Single source of truth for the CONSTITUTION.md / docs/constitution/ reference
 * pattern consumed by:
 ...
 * CLAUDE.md line 4: "L1/L2 projects must NOT reference CONSTITUTION.md — see
 * §7.5 CONSTITUTION.md Non-Propagation") is documentation OF the rule, not a
 ...
 * CONSTITUTION.md Non-Propagation rule itself. Shared with
