...
> Generated by ${BT}scripts/create-l3-scaffold.ts${BT} on **${TODAY}**.
...
- ${BT}README.md${BT} / ${BT}README_ko.md${BT} — must contain variant-specific content (regenerate via ${BT}scripts/generate-l3-readme.ts${BT})
...
- [ ] ${BT}README.md${BT} / ${BT}README_ko.md${BT} — regenerate via ${BT}bun scripts/generate-l3-readme.ts${BT} once agents/skills exist
