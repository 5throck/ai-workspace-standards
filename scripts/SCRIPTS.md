...
| `audit.ts` | L0 | 2.13.2 | active | —| —| L0+L1 | —|
...
| `create-l3-scaffold.ts` | L0 | 1.10.0 | active | —| —| L0 | —|
...
| `new-project.ts` | L0 | 1.5.4 | active | —| —| L0 | —|
...
| `upgrade-project.ts` | L0 | 1.8.1 | active | `--variant`, `--platform`, `--dry-run`, `--prune-removed`, `--rollback`, `--yes` | —| L0 | —|
