...
| `lib/upgrade-policy.ts` | L0 | 1.1.0 | active | —| —| L0 | —|
...
| `upgrade-project.ts` | L0 | 1.23.0 | active | `--variant`, `--platform`, `--dry-run`, `--prune-removed`, `--rollback`, `--yes`, `--skip-context-commonization` | —| L0 | —|
