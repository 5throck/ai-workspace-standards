...
| `resync-audit.ts` | L0 | 1.2.0 | active | v1.2.0 TEMPLATE_DELIVERED_PREFIXES gains .codex/ — .codex/** delivered files join the template-delivery comparison (spec docs/designs/2026-09-25-verifier-platform-expansion-design.md site 6) | —| L0 | —|
