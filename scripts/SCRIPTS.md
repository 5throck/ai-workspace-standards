...
| `test-l3-to-variant-promotion.ts` | L0 | 1.5.0 | active | —| —| L0 | —|
...
| `upgrade-project.ts` | L0 | 1.30.0 | active | `--variant`, `--platform`, `--dry-run`, `--prune-removed`, `--rollback`, `--yes`, `--skip-context-commonization`, `--force-context-sync` | —| L0 | —|
