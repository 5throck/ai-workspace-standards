...
| `audit.ts` | L0 | 2.20.1 | active | —| —| L0+L1 | —|
...
| `create-l3-scaffold.ts` | L0 | 1.12.0 | active | —| —| L0 | —|
| `dev-sync.ts` | L0 | 1.6.0 | active | —| —| L0+L1 | —|
...
| `l3-to-variant-pipeline.ts` | L0 | 1.12.0 | active | —| —| L0 | —|
...
| `lifecycle-sync-audit.ts` | L0 | 1.4.7 | active | —| —| L0+L1 | —|
...
| `upgrade-project.ts` | L0 | 1.10.0 | active | `--variant`, `--platform`, `--dry-run`, `--prune-removed`, `--rollback`, `--yes` | —| L0 | —|
...
| `validate-templates.ts` | L0 | 1.12.0 | active | —| —| L0 | —|
| `verify-country-prune.ts` | L0 | 1.0.0 | active | —| —| L0 | —|
| `verify-adr-governance.ts` | L0 | 1.2.0 | active | —| —| L0 | —|
...
| `verify-readme-sync.ts` | L0 | 1.2.0 | active | —| —| L0+L1 | —|
