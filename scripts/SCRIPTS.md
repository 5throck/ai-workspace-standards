...
| `agent-lifecycle-audit.ts` | L0 | 1.1.3 | active | —| —| L0+L1 | —|
...
| `audit.ts` | L0 | 2.10.5 | active | —| —| L0+L1 | —|
...
| `helpers/generate-variant.ts` | L0 | 1.7.1 | active | —| —| L0 | —|
...
| `helpers/inject-global-plugins.ts` | L0 | 1.0.1 | deprecated | 2026-09-21| —| L0 | —|
...
| `new-project.ts` | L0 | 1.2.0 | active | —| —| L0 | —|
...
| `verify-scripts.ts` | L0 | 1.2.1 | active | —| —| L0+L1 | —|
