...
| `audit.ts` | L0 | 2.28.0 | active | —| —| L0+L1 | —|
...
| `l3-to-variant-pipeline.ts` | L0 | 1.14.0 | active | —| —| L0 | —|
...
| `upgrade-project.ts` | L0 | 1.17.0 | active | `--variant`, `--platform`, `--dry-run`, `--prune-removed`, `--rollback`, `--yes` | —| L0 | —|
