...
| `skill-graph-fleet-report.ts` | L0 | 1.1.0 | active | v1.1.0: root-graph orphan cross-check in report + snapshot (`rootOrphans`) — graph-isolated root skills/agents crossed with registry/mirror/doc-reference axes (T-20260923-001, 4-way orphan criteria) | —| L0 | —|
