...
| `helpers/scaffold-markers.ts` | L0 | 1.1.0 | active | Shared scaffold marker constants + (marker→source) mapping + delivery-tree derivations for the C3/H12/H13 validator batch | —| L0+L1 | —|
...
| `validate-templates.ts` | L0 | 1.31.0 | active | —| —| L0+L1 | —|
