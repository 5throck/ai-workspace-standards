...
| `generate-skill-graph.ts` | L0 | 1.8.4 | active | —| —| L0+L1 | —|
...
| `new-project.ts` | L0 | 1.11.0 | active | —| —| L0 | —|
...
| `propagate-to-templates.ts` | L0 | 2.7.0 | active | `--apply`, `--prune`, `--dry-run`, `--check-drift`, `--governance-l1`, `--docs`, `--include-disabled`, `--marker-rewrite` | —| L0 | —|
...
| `upgrade-project.ts` | L0 | 1.19.2 | active | `--variant`, `--platform`, `--dry-run`, `--prune-removed`, `--rollback`, `--yes` | —| L0+L1 | —|
...
| `validate-templates.ts` | L0 | 1.21.2 | active | —| —| L0+L1 | —|
