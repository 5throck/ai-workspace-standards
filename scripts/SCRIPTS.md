...
| `audit.ts` | L0 | 2.26.0 | active | —| —| L0+L1 | —|
...
| `upgrade-project.ts` | L0 | 1.12.0 | active | `--variant`, `--platform`, `--dry-run`, `--prune-removed`, `--rollback`, `--yes` | —| L0 | —|
...
| `validate-templates.ts` | L0 | 1.15.2 | active | —| —| L0 | —|
