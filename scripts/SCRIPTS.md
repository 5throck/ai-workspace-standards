...
| `audit.ts` | L0 | 2.19.1 | active | —| —| L0+L1 | —|
...
| `dev-sync.ts` | L0 | 1.5.5 | active | —| —| L0+L1 | —|
...
| `helpers/prune-country-scoped-assets.ts` | L0 | 0.1.0 | active | —| —| L0 | —|
...
| `validate-templates.ts` | L0 | 1.11.0 | active | —| —| L0 | —|
