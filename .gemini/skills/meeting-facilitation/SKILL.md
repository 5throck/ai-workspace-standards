...
This is a platform skill registration entry. The full implementation lives in `.gemini/commands/meeting.md`.

**When this skill is invoked**: Read `.gemini/commands/meeting.md` immediately and follow its procedure exactly.
