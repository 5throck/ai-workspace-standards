...
APPEND 'DATA: gv_sflight_query_title TYPE char50.' TO it_source.
APPEND 'SELECTION-SCREEN BEGIN OF BLOCK b1 WITH FRAME TITLE gv_sflight_query_title.' TO it_source.
...
APPEND '  gv_sflight_query_title = ''항공편 조회 (SFLIGHT)''.' TO it_source.
