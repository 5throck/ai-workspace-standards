...
APPEND 'DATA: gv_title(50) TYPE c.' TO it_source.
...
APPEND '  gv_title = ''항공편 정보 상세 조회 (SFLIGHT)''.' TO it_source.
...
APPEND '      MESSAGE ''데이터가 없습니다'' TYPE ''S'' DISPLAY LIKE ''E''.' TO it_source.
