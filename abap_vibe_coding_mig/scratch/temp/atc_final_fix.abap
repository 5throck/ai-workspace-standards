...
APPEND 'DATA: p_title TYPE char50.' TO it_source.
APPEND 'SELECTION-SCREEN BEGIN OF BLOCK b1 WITH FRAME TITLE p_title.' TO it_source.
...
APPEND '  p_title = ''항공편 조회 (SFLIGHT)''.' TO it_source.
