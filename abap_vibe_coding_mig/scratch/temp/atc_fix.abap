...
APPEND 'DATA: gv_screen_title(50) TYPE c.' TO it_source.
APPEND 'SELECTION-SCREEN BEGIN OF BLOCK b1 WITH FRAME TITLE gv_screen_title.' TO it_source.
...
APPEND '  gv_screen_title = ''항공편 정보 상세 조회 (SFLIGHT)''.' TO it_source.
