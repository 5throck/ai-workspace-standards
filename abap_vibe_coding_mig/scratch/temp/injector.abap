...
APPEND '*&---------------------------------------------------------------------*' TO it_source.
APPEND '*& Report ZPROG_SFLIGHT_FINAL' TO it_source.
APPEND '*&---------------------------------------------------------------------*' TO it_source.
APPEND 'REPORT zprog_sflight_final.' TO it_source.
...
APPEND '    METHODS:' TO it_source.
APPEND '      fetch_data,' TO it_source.
APPEND '      display_alv.' TO it_source.
...
APPEND '    IF mt_out IS INITIAL.' TO it_source.
APPEND '      MESSAGE ''No data found'' TYPE ''S'' DISPLAY LIKE ''E''.' TO it_source.
APPEND '      RETURN.' TO it_source.
APPEND '    ENDIF.' TO it_source.
APPEND '    TRY.' TO it_source.
APPEND '        cl_salv_table=>factory(' TO it_source.
APPEND '          IMPORTING' TO it_source.
APPEND '            r_salv_table = lo_alv' TO it_source.
APPEND '          CHANGING' TO it_source.
APPEND '            t_table      = mt_out ).' TO it_source.
...
APPEND '      CATCH cx_salv_msg.' TO it_source.
APPEND '        MESSAGE ''ALV Display Error'' TYPE ''E''.' TO it_source.
APPEND '    ENDTRY.' TO it_source.
APPEND '  ENDMETHOD.' TO it_source.
APPEND 'ENDCLASS.' TO it_source.
APPEND 'START-OF-SELECTION.' TO it_source.
APPEND '  DATA(lo_report) = NEW lcl_report( ).' TO it_source.
APPEND '  lo_report->fetch_data( ).' TO it_source.
APPEND '  lo_report->display_alv( ).' TO it_source.

INSERT REPORT 'ZPROG_SFLIGHT_FINAL' FROM it_source.
COMMIT WORK.
WRITE: / 'Program injected successfully'.
