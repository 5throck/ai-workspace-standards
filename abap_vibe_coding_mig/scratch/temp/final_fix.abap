...
APPEND 'DATA: g_title TYPE char50.' TO it_source.
APPEND 'SELECTION-SCREEN BEGIN OF BLOCK b1 WITH FRAME TITLE g_title.' TO it_source.
...
APPEND '    IF mt_out IS INITIAL. MESSAGE ''No data'' TYPE ''S'' DISPLAY LIKE ''E''. RETURN. ENDIF.' TO it_source.
...
APPEND '  g_title = ''SFLIGHT Query (항공편 조회)''.' TO it_source.
