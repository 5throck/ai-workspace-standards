*&---------------------------------------------------------------------*
*& Report ZPROG_SFLIGHT_QUERY
*&---------------------------------------------------------------------*
*& Author: Antigravity
*& Description: SFLIGHT Data Query with ALV
*&---------------------------------------------------------------------*
REPORT zprog_sflight_alv.
...
CLASS lcl_report IMPLEMENTATION.
  ...
  METHOD display_alv.
    ...
    TRY.
        ...
        TRY.
          lo_columns->get_column( 'CARRNAME' )->set_short_text( 'Carrier' ).
          lo_columns->get_column( 'CARRNAME' )->set_medium_text( 'Carrier Name' ).
          lo_columns->get_column( 'CARRNAME' )->set_long_text( 'Airline Carrier Name' ).
