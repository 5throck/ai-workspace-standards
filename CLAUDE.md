...
- **PR Language**: All PR titles, bodies, and review comments **must be written in English**, regardless of the conversational language used in the session. This applies to `gh pr create`, `gh pr edit`, and any PR description generated by slash commands (`/sync`).
