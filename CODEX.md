...
> **Sequential Branch Dependency Rule**: Before running `/sync` to open a new PR while a prior PR from the same session is still open and unmerged, merge the prior PR first (or explicitly justify parallel branching in a plan/design doc). Full rule: CONSTITUTION.md §3.3.
...
- README.md, CLAUDE.md, GEMINI.md, CODEX.md, AGENTS.md, CONSTITUTION.md, CHANGELOG.md — English only
...
```
*(Not available for: CONSTITUTION.md, CLAUDE.md, GEMINI.md, CODEX.md, AGENTS.md, or any variant context.md)*
...
All shared Git/PR rules are in [CONSTITUTION.md §3](CONSTITUTION.md#3-github-pr-workflow). Codex-specific additions:
